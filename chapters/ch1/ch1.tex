...
\begin{chapterpage}
  ...
  \begin{figure}[h]
    \hrulefill\vskip1pt%
    {\color{gray5}\rule{\linewidth}{\dimexpr49pt+0.4cm\relax}}%
...
%\noindent
%\rule{\dimexpr\textwidth+\marginparsep\relax}{1pt}

\begin{figure*}[t]%
  {\color{gray9}
  \rule{\dimexpr0.22\textwidth\relax}{30ex}\hfill\color{gray7}
  \rule{\dimexpr0.22\textwidth\relax}{30ex}\hfill\color{gray5}
  \rule{\dimexpr0.22\textwidth\relax}{30ex}\hfill\color{gray3}
  \rule{\dimexpr0.22\textwidth\relax}{30ex}% this comment is important. feel free to remove it and try to figure out what happened :)
}
  \vskip1pt
  \hrulefill
  \caption{The above is the result of a \texttt{figure*},\index{figure*} an environment used for wide margins.
You should know that this redefines \texttt{\textbackslash textwidth} to the full width normally allocated for page content; you can therefore use \texttt{\textbackslash textwidth} to scale your figure's contents accordingly.}
\end{figure*}
